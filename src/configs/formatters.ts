...
export async function formatters(options: OptionsFormatters | true = {}, stylistic: StylisticConfig = {}): Promise<TypedFlatConfigItem[]> {
	...
	if (options.astro) {
		...
		configs.push({
			...
			name: 'radum/formatter/astro/disables',
			rules: {

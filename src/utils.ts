...
const isCwdInScope = isPackageExists('@radum/eslint-config');
 ...
 * @example
 * ```ts
 * import { renameRules } from '@radum/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@radum/eslint-config'

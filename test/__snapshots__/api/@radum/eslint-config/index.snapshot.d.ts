/**
 * Generated by tsnapi — public API snapshot of `@radum/eslint-config`
 */
// #region Interfaces
...
export type ConfigNames = 'radum/gitignore' | 'radum/ignores' | 'radum/javascript/setup' | 'radum/javascript/rules' | 'radum/eslint-comments/rules' | 'radum/command/rules' | 'radum/promise/rules' | 'radum/perfectionist/setup' | 'radum/node/rules/setup' | 'radum/node/rules' | 'radum/jsdoc/setup' | 'radum/jsdoc/rules' | 'radum/imports/rules' | 'radum/e18e/rules' | 'radum/unicorn/rules' | 'radum/jsx/setup' | 'radum/typescript/setup' | 'radum/typescript/parser' | 'radum/typescript/type-aware-parser' | 'radum/typescript/rules' | 'radum/typescript/rules-type-aware' | 'radum/typescript/erasable-syntax-only' | 'radum/stylistic/rules' | 'radum/regexp/rules' | 'radum/test/setup' | 'radum/test/rules' | 'radum/vue/setup' | 'radum/vue/rules' | 'radum/react/setup' | 'radum/react/rules' | 'radum/react/typescript' | 'radum/react/type-aware-rules' | 'radum/nextjs/setup' | 'radum/nextjs/rules' | 'radum/solid/setup' | 'radum/solid/rules' | 'radum/svelte/setup' | 'radum/svelte/rules' | 'radum/unocss' | 'radum/astro/setup' | 'radum/astro/rules' | 'radum/angular/setup' | 'radum/angular/rules/ts' | 'radum/angular/rules/template' | 'radum/jsonc/setup' | 'radum/jsonc/rules' | 'radum/sort/package-json' | 'radum/sort/tsconfig-json' | 'radum/pnpm/package-json' | 'radum/pnpm/pnpm-workspace-yaml' | 'radum/pnpm/pnpm-workspace-yaml-sort' | 'radum/yaml/setup' | 'radum/yaml/rules' | 'radum/toml/setup' | 'radum/toml/rules' | 'radum/markdown/setup' | 'radum/markdown/processor' | 'radum/markdown/parser' | 'radum/markdown/rules' | 'radum/markdown/disables/code' | 'radum/formatter/setup' | 'radum/formatter/css' | 'radum/formatter/scss' | 'radum/formatter/less' | 'radum/formatter/html' | 'radum/formatter/xml' | 'radum/formatter/svg' | 'radum/formatter/markdown' | 'radum/formatter/astro' | 'radum/formatter/astro/disables' | 'radum/formatter/graphql' | 'radum/disables/scripts' | 'radum/disables/cli' | 'radum/disables/bin' | 'radum/disables/dts' | 'radum/disables/cjs' | 'radum/disables/config-files';
...
export declare function promise(): Promise<TypedFlatConfigItem[]>;
export declare function radum(_?: OptionsConfig & Omit<TypedFlatConfigItem, 'files' | 'ignores'>, ..._: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[] | FlatConfigComposer<any, any> | Linter.Config[]>[]): FlatConfigComposer<TypedFlatConfigItem, ConfigNames>;

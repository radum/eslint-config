...
> Started as a rip-off of [Anthony's ESLint config preset](https://github.com/antfu/eslint-config/releases/tag/v3.8.0) amazing config but added my own flavour to it.
...
```bash
pnpm dlx @radum/eslint-config@latest
```
...
```bash
pnpm i -D eslint @radum/eslint-config
```
...
Since v7.0, we migrated to [ESLint Flat config](https://eslint.org/docs/latest/use/configure/configuration-files-new). It provides much better organization and composition.

Normally you only need to import the `radum` preset:
...
The `radum` factory function also accepts any number of arbitrary custom config overrides:
...
Check out the [configs](https://github.com/radum/eslint-config/blob/main/src/configs) and [factory](https://github.com/radum/eslint-config/blob/main/src/factory.ts) for more details.
...
The factory function `radum()` returns a [`FlatConfigComposer` object from `eslint-flat-config-utils`](https://github.com/radum/eslint-flat-config-utils#composer) where you can chain the methods to compose the config even more flexibly.
...
- [radum/dotfiles](https://github.com/radum/dotfiles) - My dotfiles
...
[MIT](./LICENSE.md) License &copy; 2019-PRESENT [Radu Micu](https://github.com/radum)
...
<table>
  <tr>
    <td align="center"><a href="http://radumicu.com/"><img src="https://avatars.githubusercontent.com/u/46779?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Radu Micu</b></sub></a><br /><a href="https://github.com/radum/eslint-config/commits?author=radum" title="Documentation">📖</a> <a href="https://github.com/radum/eslint-config/commits?author=radum" title="Code">💻</a> <a href="#infra-radum" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a> <a href="https://github.com/radum/eslint-config/commits?author=radum" title="Tests">⚠️</a></td>
  </tr>
</table>
